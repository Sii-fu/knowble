...
import '../../../core/services/instructor/teacher_feedback_service.dart';
import '../../../data/models/feedback.dart' as feedback_model;
import './widgets/instructor_empty_state_widget.dart';
import './widgets/instructor_feedback_card_widget.dart';
import './widgets/instructor_feedback_detail_dialog.dart';

class InstructorFeedbackHistoryScreen extends StatefulWidget {
  const InstructorFeedbackHistoryScreen({super.key});

  @override
  State<InstructorFeedbackHistoryScreen> createState() =>
      _InstructorFeedbackHistoryScreenState();
}

class _InstructorFeedbackHistoryScreenState
    extends State<InstructorFeedbackHistoryScreen> {
  final GlobalKey<RefreshIndicatorState> _refreshIndicatorKey =
      GlobalKey<RefreshIndicatorState>();
  final TeacherFeedbackService _feedbackService = TeacherFeedbackService();
  ...
  void _showFeedbackDetail(feedback_model.Feedback feedback) {
    showDialog(
      ...
      builder: (context) => Theme(
        ...
        child: InstructorFeedbackDetailDialog(feedback: feedback.toMap()),
      ),
    );
  }
          ...
          children: [
            ...
            if (feedback.status.toLowerCase() != 'resolved' &&
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.pushNamed(context, '/instructor-feedback-form');
                },
              ),
            ListTile(
              leading: CustomIconWidget(
  ...
  void _navigateToSubmitFeedback() {
    Navigator.pushNamed(context, '/instructor-feedback-form-screen');
  }
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData.light().copyWith(
        scaffoldBackgroundColor: AppTheme.instructorbg,
        ...
        colorScheme: ColorScheme.light(
          primary: AppTheme.instructorPrimary,
  ...
  Widget _buildEmptyState() {
    return InstructorEmptyStateWidget(
      onSubmitFeedback: _navigateToSubmitFeedback,
    );
  }
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return InstructorFeedbackCardWidget(
